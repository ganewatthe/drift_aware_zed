...
############################################################
open_project -reset absdiff
set_top absdiff
add_files absdiff/absdiff.cpp
add_files absdiff/absdiff.h
add_files -tb absdiff/absdiff_tb.cpp -cflags "-Wno-unknown-pragmas"
